    ...
    <div>
      <div className="flex flex-col border-r h-full">
        <button className="border-b border">
          <h2 className="px-6 py-4 flex flex-col font-semibold">
            Measurements
          </h2>
        </button>
        ...
        <div className="flex flex-col items-center justify-center mt-80 gap-3">
        <button className="w-[80%] h-[40px] rounded-lg font-semibold bg-secondary text-white">
        Add Element
        </button>
        <button className="w-[80%] h-[40px] rounded-lg font-semibold bg-secondary text-white">
          Export File
